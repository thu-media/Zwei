...
class Network():
    ...
    def __init__(self, sess, state_dim, action_dim, learning_rate):
        ...
        self.dual_loss = tf.cast(tf.less(self.adv, 0.), dtype=tf.float32)  * \
                        ...
                        self.ppo2loss
        self.lsacloss = -self.adv * tf.square( \
        ...
        self.loss = - tf.reduce_mean(self.lsacloss) \
            + self.entropy_weight * tf.reduce_mean(self.gini) + 0.5 * tflearn.mean_square(self.R, self.val)
