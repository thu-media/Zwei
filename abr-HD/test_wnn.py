...
M_IN_K = 1000.0
REBUF_PENALTY = 20.  # 1 sec rebuffering -> 3 Mbps
SMOOTH_PENALTY = 0.
DEFAULT_QUALITY = 1  # default video quality without agent
RANDOM_SEED = 42
RAND_RANGE = 1000
LOG_FILE = './test_results/log_sim_zwei'
...
def main():
    ...
    with tf.Session() as sess:
        ...
        while True:  # serve video forever
            ...
            bit_rate = actor.predict(np.reshape(state, (1, S_INFO, S_LEN)), True)
